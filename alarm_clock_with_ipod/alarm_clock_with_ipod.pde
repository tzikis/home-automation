...
static const byte just_play[] = {0x02, 0x00, 0x00, 0x01};
static const byte stop[] = {0x02, 0x00, 0x80};    
static const byte just_pause[] = {0x02, 0x00, 0x00, 0x02};
...
//      Serial.print(buffer[i]);
    ...
    Tx16Request txRequest = Tx16Request(0xe6fc, buffer, length+4);
    xbee.send(txRequest);
    if (xbee.readPacket(200))
    {
      //Do nothing, we just got a response telling us the packet was sent
